...
length(unique(OQ$ID)) # 969 visited at home 
...
# Check population descriptives (for report - all 969 control participants)
```{r, echo=TRUE, message=FALSE, warning=FALSE}
VGO3_metadata_all_livestock_nodups %>%
...
str(VGO3_metadata_all_livestock_nodups$age)
VGO3_metadata_all_livestock_nodups$age <- as.numeric(VGO3_metadata_all_livestock_nodups$age)
...
VGO3_metadata_all_livestock_nodups %>%
  ...
  summarise(unique_id_count = n_distinct(VGO3_ID))
VGO3_metadata_all_livestock_nodups_nohealthscore <- VGO3_metadata_all_livestock_nodups
...
str(VGO3_metadata_all_livestock_nodups_nohealthscore$health_status)
VGO3_metadata_all_livestock_nodups_nohealthscore$health_status <- as.numeric(VGO3_metadata_all_livestock_nodups_nohealthscore$health_status)
