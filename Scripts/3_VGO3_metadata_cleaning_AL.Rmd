...
```{r}
# GP metadata (n=108)
VGO3_GP_metadata <- read.csv("../Data/Metadata_VGOIII_20240108_GP.csv")
```
...
RVO2021_livestock_exp <- read.csv("../Data/Livestock_computations/RVO2021_computations.csv")
...
VGO3_metadata_all_livestock <- VGO3_metadata_all_livestock %>%
  mutate(GoatFarmExposureCategory = "Goat farmer") %>%
  mutate(GoatFarmExposureCategory = case_when(
    population %in% c("CP", "GP") & (is.na(RVO2021_MindistGoatFarm50plus_NEG) | RVO2021_MindistGoatFarm50plus_NEG <= -2000) ~ '>2000m',
    population %in% c("CP", "GP") & RVO2021_MindistGoatFarm50plus_NEG >= -1000 ~ '<1000m',
    population %in% c("CP", "GP") & RVO2021_MindistGoatFarm50plus_NEG > -2000 ~ '1000-2000m',
    TRUE ~ GoatFarmExposureCategory
  ))
...
VGO3_lab_metadata <- read.xlsx("../Data/Lab_metadata_fromMariLee/VGO3_meta.xlsx", rowNames = TRUE)
