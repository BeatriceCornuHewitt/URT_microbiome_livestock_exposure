...
# Packages
```{r}
library(mltools); library(ranger); library(mlr3); library(tuneRanger); library(openxlsx); library(dplyr); library(writexl); library(MLmetrics); library(randomForestSRC); library(mlr3); library(mlr); library(mlrMBO); library(ggplot2); library(writexl)
```
# Data 
```{r}
...
# Copy over the ps object 
ps_complete_KRD <- ps_complete
# Remove 'KRD_' string from the sample data variable names in the copied phyloseq object
sample_data(ps_complete_KRD) <- sample_data(ps_complete_KRD)
names(sample_data(ps_complete_KRD)) <- gsub("KRD_", "", names(sample_data(ps_complete_KRD)))

# Check the updated variable names
print(names(sample_data(ps_complete_KRD)))



# CONTINUE _ missing the sheep variables from KRD 2022 data

# Extract the sam data from the ps
sample_data_df <- data.frame(sample_data(ps_complete_KRD))
# Create a named vector for the column renaming
new_names <- c(
  "AllFarm.1000m" = "nAnyFarm_1000m",
  "AllFarm.250m" = "nAnyFarm_250m",
  "AllFarm.3000m" = "nAnyFarm_3000m",
  "AllFarm.500m" = "nAnyFarm_500m",
  "CattleFarm.1000m" = "nCattleFarm.1000m",
  "CattleFarm.3000m" = "nCattleFarm.3000m",
  "CattleFarm.500m" = "nCattleFarm.500m",
  "GoatFarm.3000m" = "nGoatFarm.3000m",
  "HorseFarm.1000m" = "nHopoFarm.1000m",
  "HorseFarm.3000m" = "nHopoFarm.3000m",
  "MinDistAnyFarm.INV" = "MindistAnyFarm.INV",
  "MinDistAnyFarm.NEG" = "MindistAnyFarm.NEG",
  "MindistCows5.INV" = "MindistCattleFarm5.INV",
  "MindistCows5.NEG" = "MindistCattleFarm5.NEG",
  "MindistGoats50.INV" = "MindistGoatFarm50.INV",
  "MindistGoats50.NEG" = "MindistGoatFarm50.NEG",
  "MindistHorses5.INV" = "MindistHopoFarm5.INV",
  "MindistHorses5.NEG" = "MindistHopoFarm5.NEG",
  "MindistPigs15.INV" = "MindistPigFarm15.INV",
  "MindistPigs15.NEG" = "MindistPigFarm15.NEG",
  "MindistPoultry250.INV" = "MindistPoultryFarm250.INV",
  "MindistPoultry250.NEG" = "MindistPoultryFarm250.NEG",
  "nAnyFarmWghtDist.1000m.sum" = "nAnyFarmWghtDist_1000m",
  "nAnyFarmWghtDist.3000m.sum" = "nAnyFarmWghtDist_3000m",
  "nCattleFarmWghtDist.1000m.sum" = "nCattleFarmWghtDist.1000m.sum",
  "nCattleFarmWghtDist.3000m.sum" = "nCattleFarmWghtDist.3000m.sum",
  "ncows.1000m" = "nCows.1000m",
  "ncows.3000m" = "nCows.3000m",
  "ncows.500m" = "nCows.500m",
  "ncowsWghtDist.1000m.sum" = "nCowsWghtDist.1000m.sum",
  "ncowsWghtDist.3000m.sum" = "nCowsWghtDist.3000m.sum",
  "nGoatFarmWghtDist.3000m.sum" = "nGoatFarmWghtDist.3000m.sum",
  "ngoats.3000m" = "nGoats.3000m",
  "ngoatsWghtDist.3000m.sum" = "nGoatsWghtDist.3000m.sum",
  "nHorseFarmWghtDist.1000m.sum" = "nHopoFarmWghtDist.1000m.sum",
  "nHorseFarmWghtDist.3000m.sum" = "nHopoFarmWghtDist.3000m.sum",
  "nhorses.1000m" = "nHopo.1000m",
  "nhorses.3000m" = "nHopo.3000m",
  "nhorses.500m" = "nHopo.500m",
  "nhorsesWghtDist.1000m.sum" = "nHopoWghtDist.1000m.sum",
  "nhorsesWghtDist.3000m.sum" = "nHopoWghtDist.3000m.sum",
  "nPigFarmWghtDist.1000m.sum" = "nPigFarmWghtDist.1000m.sum",
  "nPigFarmWghtDist.3000m.sum" = "nPigFarmWghtDist.3000m.sum",
  "npigs.1000m" = "nPigs.1000m",
  "npigs.3000m" = "nPigs.3000m",
  "npigs.500m" = "nPigs.500m",
  "npigsWghtDist.1000m.sum" = "nPigsWghtDist.1000m.sum",
  "npigsWghtDist.3000m.sum" = "nPigsWghtDist.3000m.sum",
  "npoultry.1000m" = "nPoultry.1000m",
  "npoultry.3000m" = "nPoultry.3000m",
  "npoultry.500m" = "nPoultry.500m",
  "nPoultryFarmWghtDist.1000m.sum" = "nPoultryFarmWghtDist.1000m.sum",
  "nPoultryFarmWghtDist.3000m.sum" = "nPoultryFarmWghtDist.3000m.sum",
  "npoultryWghtDist.1000m.sum" = "nPoultryWghtDist.1000m.sum",
  "npoultryWghtDist.3000m.sum" = "nPoultryWghtDist.3000m.sum",
  "PigFarm.1000m" = "nPigFarm.1000m",
  "PigFarm.3000m" = "nPigFarm.3000m",
  "PigFarm.500m" = "nPigFarm.500m",
  "PoultryFarm.1000m" = "nPoultryFarm.1000m",
  "PoultryFarm.3000m" = "nPoultryFarm.3000m",
  "PoultryFarm.500m" = "nPoultryFarm.500m"
)

# Check original column names in sample_data_df
original_colnames <- colnames(sample_data_df)
# Filter new_names to only those present in sample_data_df
valid_names <- new_names[names(new_names) %in% original_colnames]
# Rename columns in sample_data_df
sample_data_df <- sample_data_df %>% rename(!!!valid_names)
```
...
# CONTINUE HERE WHEN HAVE SHEEP VARIABLES - NEED TO RENAME THESE TOO IN THIS SCRIPT
...
```{r}
# Check the names of the variables in the RF model
RF_ecoli_wins$forest$independent.variable.names


# CONTINUE HERE WHEN HAVE SHEEP VARIABLES
# Use E. coli model to predict residential exposures
ecoli_RF_estimates <- ranger::predict(final_model_ecoliRF2_500trees, data = sample_data_df) 
